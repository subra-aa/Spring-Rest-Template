...
public class Astro {
     ...
     * @param moonrise
     */
    public Astro(String sunrise, String sunset, String moonrise, String moonset, String moon_phase, String moon_illumination, long is_moon_up, long is_sun_up) {
        super();
    ...
    public long getIs_moon_up() {
        return is_moon_up;
    }

    public void setIs_moon_up(long is_moon_up) {
        this.is_moon_up = is_moon_up;
    }

    public long getIs_sun_up() {
        return is_sun_up;
    }

    public void setIs_sun_up(long is_sun_up) {
        this.is_sun_up = is_sun_up;
    }
